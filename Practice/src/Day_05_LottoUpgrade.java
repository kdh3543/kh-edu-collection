public class Day_05_LottoUpgrade {
	...
	public static void main(String[] args) {
		...
		System.out.println("2등 당첨 횟수: "+sec + " 당첨 확률: " + (double)sec/t);
		System.out.println("3등 당첨 횟수: "+thd + " 당첨 확률: " + (double)thd/t);
		System.out.println("4등 당첨 횟수: "+four + " 당첨 확률: " + (double)four/t);
		System.out.println("5등 당첨 횟수: "+fifth + " 당첨 확률: " + (double)fifth/t);
	}
}